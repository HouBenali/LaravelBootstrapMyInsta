    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('update') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="surname" type="text" class="form-control @error('surname') is-invalid @enderror" name="surname" value="{{ old('surname',$info->surname) }}" required autocomplete="surname" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nick" type="text" class="form-control @error('nick') is-invalid @enderror" name="nick" value="{{ old('nick',$info->nick) }}" required autocomplete="nick" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email',$info->email) }}" required autocomplete="email">
                        ...
                        <div class="form-group row">
                            ...
                            @if(!$user->photo)
                                <img  class="profile" alt="avatar" src="https://raw.githubusercontent.com/HouBenali/Assets/main/avatar.png"/>
                            @else
            ...
            <div class="card">
                ...
                <div class="card-body">
                    @if (session('updatedPass'))
                        <h4 class="message">Password updated successfully</h4>
                    @endif
